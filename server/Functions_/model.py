...
"""
path1 = "Functions_/downloaded-model/Symptom-severity.csv"
path2 = "Functions_/downloaded-model/symptom_Description.csv"
path3 = "Functions_/downloaded-model/symptom_precaution.csv"
